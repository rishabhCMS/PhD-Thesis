...
The electromagnetic Calorimeter (ECAL) is a homogeneous and hermetic detector which measures the energy of the electromagnetically interacting particles like photons, electrons and positrons. It consists of two main components- The barrel region composed of 61,200 lead tungstate ($PbWO_{4}$) crystals covering the region in $|\eta| < 1.479$, and the two endcap regions composed of 14,648 crystals covering the region $1.479 < |\eta|  < 3$. 
The choice of $PbWO_{4}$ crystals is motivated by the following reasons. Its short radiation length, small $Moli\acute{e}re$ (\SI{2.19}{\cm})and high density (\SI{8.27}{\g\cm^{3}}) results in high energy resolution. It's a fast scintillator (meaning 80$\%$ of the scintillation light is emitted within 25 $ns$ of the particle's incidence on the crystal. It is easy to produce these $PbWO_{4}$ crystals with readily available raw materials \citep{CMS:1997ecal}.

When an Electron/Photon traverses the ECAL crystals, it results in a cascade of electromagnetic interactions, producing a shower of particles such that the sum of there energy is proportional to the energy of the incident particle. Inside the ECAL these particles release photons which are detected by the photo-detectors at the end of the crystals
