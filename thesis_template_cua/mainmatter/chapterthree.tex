...
The DTs measure the muon position in the barrel part of the detector in the $|\eta| < 1.2$ region. They consist of 4 barrel layers parallel to the beam axis placed alternatively between the return yolk layers of the magnet. Each DT layer is formed by a 4 cm wide Aluminum tube containing a stretched  wire in a gas volume. The wire is maintained at a potential difference, this potential difference creates an electric field which attracts the ionized gas atoms. When a muon passes the DT it ionizes the gas atoms these atoms drift in the presence of electric field to the wires and the signal produced by there ionized atoms acts as a proxy for the muons. This mechanism is illustrated in Figure \ref{cms:dt}

\begin{figure} [tpb]
\centering
         \includegraphics[width=0.9\textwidth,clip=]{thesis_template_cua/Figures/CMS_LHC_chapter/dt.png}
         \vspace*{10mm}
         \caption[CMS Muon System]{Diagram showing the mechanism of passing muons through DT ionizes the gas atoms. These gas atoms move in the presence of electric field thus producing a signal for the presence of muons}
         \label{cms:dt}
\end{figure}
